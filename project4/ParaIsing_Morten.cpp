...
{
  string filename;
  int NSpins, BurnInMonteCarloCycles, MonteCarloCycles;
  ...
  if (RankProcess == 0 && argc <= 6) {
    cout << "Bad Usage: " << argv[0] <<
      " read output file, Number of spins, burn-in MC cycles, MC cycles, initial and final temperature and tempurate step" << endl;
    exit(1);
  }
