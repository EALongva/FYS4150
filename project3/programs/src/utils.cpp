...
ss import_solarsys(){
  ...
  planet mercury(name_mercury, M_mercury, mercury_pos, mercury_vel);
  planet venus(name_venus, M_venus, venus_pos, venus_vel);
  planet mars(name_mars, M_mars, mars_pos, mars_vel);
  planet jupiter(name_jupiter, M_jupiter, jupiter_pos, jupiter_vel);
  planet saturn(name_saturn, M_saturn, saturn_pos, saturn_vel);
  planet uranus(name_uranus, M_uranus, uranus_pos, uranus_vel);
  planet neptune(name_neptune, M_neptune, neptune_pos, neptune_vel);
  planet pluto(name_pluto, M_pluto, pluto_pos, pluto_vel);
