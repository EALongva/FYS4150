...
plt.scatter(lattice40['T'], lattice40['Chi']/(40*40), label=r'$L=40$')
plt.scatter(lattice60['T'], lattice60['Chi']/(60*60), label=r'$L=60$')
plt.scatter(lattice80['T'], lattice80['Chi']/(80*80), label=r'$L=80$')
